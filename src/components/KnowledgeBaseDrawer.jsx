...
export default function KnowledgeBaseDrawer({ trackMode, isOpen: controlledIsOpen, onToggle }) {
  ...
  return (
    <div id="knowledge-base-section" className="mt-8 border-t border-[#ECE6DC] pt-8 scroll-mt-24">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-xs md:text-sm text-stone-300 mt-1 font-normal">
              Explore the Coffee Belt (23.5° N - 23.5° S), Arabica vs. Robusta species agronomy, and specialty tea garden terroirs.
            </p>
          </div>
        </div>
