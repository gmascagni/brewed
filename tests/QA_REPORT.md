...
**Execution Date:** `2026-09-12 17:00:25`  
**Total Cases:** `29` | **Passed:** `3` | **Failed:** `26`

| ID | Domain | Use Case Name | Status | Duration | Notes |
|---|---|---|---|---|---|
| `UC-1.1` | Header | Coffee / Tea Track Mode Switching | ❌ FAIL | 4.57s | Header does not show 'Shop Local Coffee' button |
...
| `UC-2.1` | Brewing | Step 01 Method Selection & URL Update | ❌ FAIL | 4.60s | V60 Dripper method card not found on grid |
...
| `UC-3.1` | Roasters | Roaster Showcase Page (/roasters) Mounting | ❌ FAIL | 5.05s | Roaster showcase page /roasters failed to mount correctly: {'h1': "Hmmm… can't reach this page", 'hasRoasterPartnerTag': False} |
...
| `UC-3.5` | Roasters | Persistent Back Navigation to Brewing Station | ❌ FAIL | 4.55s | Brewing Station back button not found on /roasters |
| `UC-4.1` | Academy | Academy Library Catalog Default 16-Card Grid | ❌ FAIL | 3.06s | Academy button not found in header |
| `UC-4.2` | Academy | Category Filtering (Pour-Over, Espresso, etc.) | ❌ FAIL | 1.01s | Espresso category filtering returned 0 cards |
| `UC-4.3` | Academy | Masterclass Title & Creator Search Input | ✅ PASS | 1.51s | Verified |
| `UC-4.4` | Academy | Theater Player Mode YouTube Embed | ❌ FAIL | 1.50s | 'str' object has no attribute 'get' |
...
| `UC-5.3` | WaterLab | Static Water Chemistry Guide Landing Routes | ❌ FAIL | 5.04s | Failed to load /guides/water-chemistry-gh-kh |
| `UC-6.1` | Scanner | Barcode Scanner Modal Frame & Video Target | ❌ FAIL | 3.04s | Scan Bag button not found in header |
...
| `UC-9.1` | News | World Brew News & Rel Noopener Sec Audit | ❌ FAIL | 4.55s | World News element not found |
| `UC-10.1` | Viewports | 5-Point Responsive Viewport Inspection | ❌ FAIL | 1.01s | Header not visible at viewport Mobile SE (375x667) |
